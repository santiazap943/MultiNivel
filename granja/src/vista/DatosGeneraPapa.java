 ...
 */
public class DatosGeneraPapa extends javax.swing.JFrame {

 
    public DatosGeneraPapa() {
        initComponents();
    }
    ...
    private void cargarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cargarBtnActionPerformed
        try {
            ...
            Logger.getLogger(DatosGeneraPapa.class.getName()).log(Level.SEVERE, null, ex);
        }
