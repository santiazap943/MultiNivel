 ...
 */
public class MenuFresa extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 0, -1, 70));
    ...
    private void infoinicialBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_infoinicialBtnActionPerformed
        InfoIncialFresa ob1 = new InfoIncialFresa ();
        ob1.setVisible(true);
        setVisible(false);
    ...
    private void infoinicialBtn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_infoinicialBtn1ActionPerformed
        DatosGeneraFresa datosf = new DatosGeneraFresa ();
